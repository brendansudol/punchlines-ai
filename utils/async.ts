...
export type AsyncValue<V> = AsyncNotStarted | AsyncLoading | AsyncLoaded<V> | AsyncFailedLoading
...
export function isLoaded<T>(value: AsyncValue<any>): value is AsyncLoaded<T> {
  return value.status === "LOADED"
}

export function isFailedLoading(value: AsyncValue<any>): value is AsyncFailedLoading {
